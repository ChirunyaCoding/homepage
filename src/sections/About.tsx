...
import { User, Heart, Code2, Coffee, Mail, Twitter, Github, Youtube, MapPin } from "lucide-react";
...
const socialLinks = [
  { name: "YouTube", icon: Youtube, href: "#", color: "from-red-500 to-rose-500" },
              ...
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <Button
                      size="sm"
                      className="bg-gradient-to-r from-cyan-400 to-sky-500 text-white shadow-md"
                    >
